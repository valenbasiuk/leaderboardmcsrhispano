...
function getRankIcon(elo) {
    if (!elo) return 'public/ranks/unrated.png';
    if (elo >= 2000) return 'public/ranks/netherite.png';
    if (elo >= 1800) return 'public/ranks/diamond_3.png';
    if (elo >= 1650) return 'public/ranks/diamond_2.png';
    if (elo >= 1500) return 'public/ranks/diamond_1.png';
    if (elo >= 1400) return 'public/ranks/emerald_3.png';
    if (elo >= 1300) return 'public/ranks/emerald_2.png';
    if (elo >= 1200) return 'public/ranks/emerald_1.png';
    if (elo >= 1100) return 'public/ranks/gold_3.png';
    if (elo >= 1000) return 'public/ranks/gold_2.png';
    if (elo >= 900) return 'public/ranks/gold_1.png';
    if (elo >= 800) return 'public/ranks/iron_3.png';
    if (elo >= 700) return 'public/ranks/iron_2.png';
    if (elo >= 600) return 'public/ranks/iron_1.png';
    if (elo >= 500) return 'public/ranks/coal_3.png';
    if (elo >= 400) return 'public/ranks/coal_2.png';
    return 'public/ranks/coal_1.png';
}
